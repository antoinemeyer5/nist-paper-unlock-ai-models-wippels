...
\begin{tikzpicture}
    ...
    \draw node [label={[xshift=2.9cm, yshift=1.1cm] \tiny 26 fields}] {};
    ...
    \draw node [label={[xshift=-2.9cm, yshift=1.1cm] \tiny 43 fields}] {};
    ...
    \draw node [label={[xshift=-1.7cm, yshift=1.2cm] \tiny 16 fields}] {}; % HG x GP
